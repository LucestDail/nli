...
정적·경량. 실데이터 계산하되 추천/가성비 '값'은 마스킹(제품가치 보호). 출처 32종은 마퀴로 노출.
...
<div class="nav"><span>🏘 <b class="brand-lb">동네살기지수</b></span>
  <div class="sp">
    ...
    <a class="p" href="mailto:lucestdail@kakao.com?subject=%5B%EB%8F%99%EB%84%A4%EC%82%B4%EA%B8%B0%EC%A7%80%EC%88%98%5D%20%EB%AC%B8%EC%9D%98"><span class="lb">문의</span></a>
  </div></div>
