 ...
 *{box-sizing:border-box}
 ...
 .diagdash{display:grid;grid-template-columns:minmax(0,440px) 1fr;gap:16px;align-items:start}
 .diagdash>.card{max-height:76vh;overflow:auto}
 @media(max-width:900px){.diagdash{grid-template-columns:1fr}.diagdash>.card{max-height:none}.diagdash>.card:last-child{max-height:60vh}}
...
<div id="app">
 ...
 <div class="view" id="v-diag" style="display:none"><div class="wrap inswrap">
   ...
   <div class="sub" style="margin-bottom:12px">시군구 단위 <b>취약 도메인</b>·<b>사각지대 동</b>(인구 1만+ 하위 20%) 진단 · 우측 표에서 지자체를 고르면 좌측 리포트가 갱신됩니다.</div>
