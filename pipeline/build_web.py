...
<div id="app">
 ...
 <div class="view" id="v-home" style="display:none"><div class="wrap">
   ...
   <div class="card domcard"><div class="flex" style="justify-content:space-between;align-items:baseline;margin-bottom:14px"><h3 style="margin:0">9개 생활 도메인</h3><span class="muted">각 도메인을 여러 공공데이터 지표로 정량화 · 총 30개 지표</span></div><div class="domgrid" id="domGrid"></div></div>
