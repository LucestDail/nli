...
SETS = {
    ...
    "cd": ("어린이집", f"{RAW}/전국어린이집_운영중_좌표.csv", "csv", "경도", "위도", "어린이집명", ["주소"], "어린이집전화번호", ["어린이집유형구분"]),
    "lb": ("도서관", f"{RAW}/전국도서관표준데이터.csv", "csv", "경도", "위도", "도서관명", ["소재지도로명주소"], "도서관전화번호", []),
    "sp": ("체육시설", f"{RAW}/전국체육시설_공공_좌표.csv", "csv", "시설좌표경도", "시설좌표위도", "시설명", ["시설도로명주소", "시설주소"], "", ["시설구분명"]),
    "pg": ("주차장", f"{RAW}/전국주차장정보표준데이터.csv", "csv", "경도", "위도", "주차장명", ["소재지도로명주소", "소재지지번주소"], "전화번호", ["주차장구분"]),
    "sr": ("경로당·마을회관", f"{RAW}/전국마을회관및경로당표준데이터.csv", "csv", "경도", "위도", "시설명", ["소재지도로명주소", "소재지지번주소"], "전화번호", []),
}
