...
const DOMFAC={D1:[['ph','약국',1],['cl','의료기관',1],['em','응급의료기관',1]],D2:[['sc','학교',1]],D3:[['st','상가',0]],D4:[['pk','공원',1]],D5:[['bs','버스정류장',1]],D6:[['cc','CCTV',1]],D7:[['ev','전기차충전소',1]],D8:[['wf','사회복지시설',1]]};
...
const PRESETS={
 '균등':[1,1,1,1,1,1,1,1],
 '정보량(엔트로피)':[0.80,0.46,1.87,0.99,0.67,0.72,1.25,1.24],
 'CRITIC(중복보정)':[0.79,0.65,1.52,0.86,0.99,0.92,1.16,1.11],
