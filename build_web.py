...
const PRESETS={
 ...
 '정보량(엔트로피)':[1.43,0.91,0.63,0.68,0.60,0.64,0.53,1.12,2.45],
 'CRITIC(중복보정)':[1.01,0.89,0.88,0.69,0.74,0.78,1.06,1.42,1.54],
...
function detailHTML(p){
  ...
  return h;}
function showDetail(p,focus){const d=document.getElementById('detail');d.innerHTML=detailHTML(p);d.style.display='block';growBars();curDetail=p.adm_nm;writeHash();
