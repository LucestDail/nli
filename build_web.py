...
const DOMFAC={D1:[['ph','약국',1],['cl','의료기관',1],['em','응급의료기관',1]],D2:[['sc','학교',1],['cd','어린이집',1],['lb','도서관',1]],D3:[['st','상가',0]],D4:[['pk','공원',1],['sp','체육시설',1]],D5:[['bs','버스정류장',1],['pg','주차장',1]],D6:[['cc','CCTV',1],['cz','어린이보호구역',1]],D7:[['ev','전기차충전소',1],['ht','무더위쉼터',1]],D8:[['wf','사회복지시설',1]]};
...
const PRESETS={
 '균등':[1,1,1,1,1,1,1,1],
 '정보량(엔트로피)':[1.04,0.66,2.45,0.64,0.63,0.43,0.53,1.62],
 'CRITIC(중복보정)':[0.94,0.79,1.86,0.73,0.83,0.77,0.79,1.29],
