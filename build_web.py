...
const DOMFAC={D1:[['ph','약국',1],['cl','의료기관',1],['em','응급의료기관',1]],D2:[['sc','학교',1],['cd','어린이집',1],['lb','도서관',1]],D3:[['st','상가',0]],D4:[['pk','공원',1],['sp','체육시설',1]],D5:[['bs','버스정류장',1],['pg','주차장',1]],D6:[['cc','CCTV',1],['cz','어린이보호구역',1]],D7:[['ev','전기차충전소',1]],D8:[['wf','사회복지시설',1]]};
...
const PRESETS={
 '균등':[1,1,1,1,1,1,1,1],
 '정보량(엔트로피)':[0.92,0.58,2.15,0.56,0.55,0.38,1.44,1.42],
 'CRITIC(중복보정)':[0.86,0.72,1.73,0.66,0.78,0.74,1.29,1.22],
