...
| D8 복지·돌봄 | 사회복지시설(VWorld 지오코딩 85% 커버) · 경로당·마을회관 |
| D9 반려·동물 | 동물병원 |
...
7탭 SPA(지도 기본·홈·순위·비교·맞춤설정·통계·진단):
...
- **비교**: 최대 4곳 지표 비교
- **통계**: 지역특성×도메인 상관 히트맵 · 도농 격차(명칭/밀도 토글) · 시도 순위 · 산점도·회귀(평문 해석) · **가성비 동네**(살기지수÷아파트값)
- **🩺 진단(B2G)**: 지자체 229곳 생활여건 진단 — 취약 도메인·사각지대 동 자동판정 · 진단 리포트(복사·PDF) · 지도 연동
